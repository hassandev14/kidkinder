                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="form-horizontal" role="form">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-2 control-label" for="image_name">Description</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-2 control-label" for="image_name">Total Seats</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="seats" class="form-control" placeholder="Total Seats">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 control-label" for="image_name">Class Time</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="time" class="form-control" placeholder="Class Time">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 control-label" for="image">Tution Fee</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-10">
                                                    <input type="submit" value="submit" name="add_classes"> 
                                                    </div>
                                                </div>
                                            </form>
                                        </div> <!-- card-body -->
